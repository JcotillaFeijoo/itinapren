...
HTMLArea.Config = function () {
	...
	this.btnList = {
		...
		cut: [ "Retalla el tros de text", "ed_cut.gif", false, cut_copy_paste ],
		copy: [ "Copia el tros de text", "ed_copy.gif", false, cut_copy_paste ],
		paste: [ "Enganxa el tros de text", "ed_paste.gif", false, cut_copy_paste ],
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
		...
		try {
			...
			if (HTMLArea.is_gecko) {
				if (confirm("Per raons de seguretat en aquest navegador s'han desactivat els botons de Retallar/Copiar/Enganxar."+
				 "Tens dues opcions per  fer-ho, o b� pel men� del navegador a Edit (Editar) les opcions Cut (Tallar), Copy (Copiar) i Paste (Enganxar)" +
				 ", o b�, prem el bot� OK i se t'obrir� una nota de mozilla.org on t'explicaran en angl�s com activar aquestes opcions"))
...
HTMLArea.checkSupportedBrowser = function() {
	if (HTMLArea.is_gecko) {
		//discard chrome so always returns the same value - 20030107
