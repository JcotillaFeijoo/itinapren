...
HTMLArea.Config = function () {
	...
	this.btnList = {
		...
		hilitecolor: [ "Selecciona el text i marca!", "ed_color_bg.gif", false, function(e) {e.execCommand("hilitecolor");} ],
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
	    ...
	    case "forecolor":
		editor._doc.execCommand(cmdID, false, "#FFFF00");
		break;
	    case "createlink":
		this._createLink();
		break;
